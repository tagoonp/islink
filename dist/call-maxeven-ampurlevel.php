...
$strSQL = "SELECT MAX(counted) FROM ( SELECT COUNT(*) AS counted FROM isdata54 WHERE APLACE = '40' and ADATE between '2011-01-01' and '2011-12-31' GROUP BY Aampur ) AS counts";
